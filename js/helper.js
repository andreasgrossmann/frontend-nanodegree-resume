...
var HTMLskills = '<li class="flex-item"><span class="dark-text"><i class="fa fa-check green-text" aria-hidden="true"></i> %data%</span></li>';

var HTMLworkStart = '<div class="work-entry typewriter-text"></div>';
var HTMLworkEmployer = '<a href="#">%data%';
var HTMLworkTitle = ' - %data%</a>';
var HTMLworkDates = '<div class="date-text typewriter-text">%data%</div>';
var HTMLworkLocation = '<div class="location-text typewriter-text">%data%</div>';
var HTMLworkDescription = '<p class="typewriter-text"><br>%data%</p>';

var HTMLprojectStart = '<div class="project-entry"></div>';
var HTMLprojectTitle = '<a href="#">%data%</a>';
var HTMLprojectDates = '<div class="date-text yellow-text">%data%</div>';
var HTMLprojectDescription = '<p><br>%data%</p>';
var HTMLprojectImage = '<img src="%data%">';

var HTMLschoolStart = '<div class="education-entry typewriter-text"></div>';
var HTMLschoolName = '<a href="#">%data%';
var HTMLschoolDegree = ' -- %data%</a>';
var HTMLschoolDates = '<div class="date-text typewriter-text">%data%</div>';
